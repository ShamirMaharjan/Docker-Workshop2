            ...
            <main className="max-w-4xl mx-auto p-6 lg:p-8">
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 py-2.5 bg-slate-50 hover:bg-slate-100 text-white-700 rounded-xl font-bold transition-colors shadow-md"
                            >
                                <Shield className="h-4 w-4" /> Security & Identity
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <h3 className="text-3xl font-black text-gray-900">{activeTaskCount}</h3>
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mt-1">Active Tasks</p>
                    </div>

                    <div className={"bg-gradient-to-br from-orange-400 to-red-500 p-5 rounded-3xl shadow-md flex-col justify-center items-center text-center transform hover:scale-105 transition-transform cursor-default"}>
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                        ...
                        <div className="bg-gray-50 border border-dashed border-gray-900 mb-4 flex items-center gap-2">
                            <p className="text-gray-400 font-medium mb-2">Analyzing your workflow patterns...</p>
                            <p className="text-gray-400 text-sm">Your emotion-aware companion will appear here once enough data is gathered.</p>
                        </div>
                    </div>
